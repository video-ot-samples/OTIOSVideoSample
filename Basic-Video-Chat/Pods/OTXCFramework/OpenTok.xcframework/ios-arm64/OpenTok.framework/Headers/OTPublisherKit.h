 ...
 * disabled) for publishers using the camera. When using the
 * screen video type, the <code>publisherAudioFallbackEnabled</code> property is set
 * to <code>NO</code> by default, so that the video does not drop out
 * in subscribers.
 *
 * For more information, see <[OTPublisherKit videoType]>,
...
* a None", "High", and "Low".
*/
- (nullable id)initWithName:(NSString*)name_ properties:(NSString *)properties_;
...
*/
- (nullable id)initWithName:(NSString*)name_ transformer:(nonnull id<OTCustomVideoTransformer>)customVideoTransformer_;
...
*/
- (nullable id)initWithName:(NSString*)name_ transformer:(nonnull id<OTCustomAudioTransformer>)customAudioTransformer_;
